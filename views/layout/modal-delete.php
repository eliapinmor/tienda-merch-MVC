<div id="delete-modal" class="fixed inset-0 z-50 hidden flex items-center justify-center bg-black/50 backdrop-blur-sm">
    <div class="bg-white rounded-2xl p-8 max-w-sm w-full mx-4 shadow-2xl border-t-4 border-red-500">
        <div class="text-center">
            ...
            <p class="text-gray-600 mb-6">Esta acción no se puede deshacer y el elemento desaparecerá de la base de datos.</p>
            
            <form id="delete-form" method="POST" action="">
                <input type="hidden" name="id" id="delete-id" value="">
                <div class="flex flex-col gap-3">
                    <button type="submit" class="bg-red-600 text-white py-3 rounded-xl font-bold hover:bg-red-700 transition">Eliminar permanentemente</button>
